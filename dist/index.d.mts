...
declare const TagTypeLfIdLen: Map<TagType, number>;
declare const HidProxFormatName: Map<HidProxFormat, string>;
/**
 * Get the maximum page number of a specific mifare ultralight tag type.
 */
declare const MfuMaxPage: Map<TagType | NxpMfuType, number>;
declare const NxpMfuTypeName: Map<TagType | NxpMfuType, string>;
...
export { AnimationMode, ButtonAction, ButtonType, ChameleonUltra, Cmd, DarksideStatus, DeviceMode, DeviceModel, DfuFwId, DfuFwType, DfuObjType, FreqType, Hf14aBccMode, Hf14aCascadeLevelMode, Hf14aRatsMode, HidProxFormat, HidProxFormatName, Mf1EmuWriteMode, Mf1KeyType, Mf1PrngType, Mf1VblockOperator, MfuEmuWriteMode, MfuMaxPage, NxpMfuType, NxpMfuTypeName, Slot, TagType, TagTypeLfIdLen, version };
